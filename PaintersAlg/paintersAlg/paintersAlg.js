...
function setup() {
  ...
  testComparator = (a, b) => {
    let distanceA = dist(a.p1.x, a.p1.y, a.p1.z, camera.eyeX, camera.eyeY, camera.eyeZ);
    let distanceB = dist(b.p1.x, b.p1.y, b.p1.z, camera.eyeX, camera.eyeY, camera.eyeZ);
